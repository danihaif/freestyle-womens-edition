            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 sm:p-10 lg:p-16 border border-white/20">
              ...
              <div className="max-w-4xl mx-auto space-y-6 text-right">
                <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
                  ...
                  הקורס מיועד לנשים שעובדות עם אנשים ומול אנשים, מרגישות שהפרפקציוניזם, הפחד לטעות והביקורת העצמית גורמים להן לעצור- גם כשהן יודעות שיש להן הרבה מה לתת.
                </p>
        ...
        <AnimatedSection delay={100}>
          <section id="who-for" className="mb-16 lg:mb-24 scroll-mt-28">
            <div className="max-w-4xl mx-auto text-right">
              ...
              <div className="space-y-6">
                <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
                  לנשים שעובדות עם ומול א.נשים. מנהלות, יזמיות, מובילות תחום, מנחות קבוצות, מטפלות, מנהלות HR וכל מי שרוצה לחזק ביטוי עצמי, נוכחות ולתקשר את עצמה בביטחון.
                </p>
            ...
            <div className="grid md:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto">
              ...
              <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20 hover:shadow-3xl transition-all duration-300 hover:scale-105">
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-base text-gray-700 leading-relaxed text-center">
                   VP HR ו-Executive Coach, עם רקע בפסיכולוגיה (B.A) וחינוך (M.A). מגיעה מעולמות משאבי האנוש והפיתוח הארגוני, ועובדת עם מנהלות.ים וצוותים בתהליכי צמיחה ושינוי.
                  </p>
                </div>
              </div>
            </div>
